...
-->
	<div id="accordionResizer" class="ui-widget-content">
		<div id="accordionAdmin">
			...
			<div>
				<ol id="userSelect">
					<li class="ui-widget-content adminListItem">Manage User</li>
				</ol>
			</div>
			...
			<div>
				<ol id="roleSelect">
					<li class="ui-widget-content adminListItem">View Role</li>
					<li class="ui-widget-content adminListItem">Add Role</li>
					<li class="ui-widget-content adminListItem">Manage Role</li>
				</ol>
			</div>
			...
			<div>
				<ol id="teamSelect">
					<li class="ui-widget-content adminListItem">Add Team</li>
					<li class="ui-widget-content adminListItem">Manage Team</li>
				</ol>
			</div>
